...
@endsection@extends('layouts.app', ['activePage' => 'dashboard', 'title' => 'Light Bootstrap Dashboard Laravel by Creative Tim & UPDIVISION', 'navName' => 'Dashboard', 'activeButton' => 'laravel'])

@section('content')
    <form>
        @csrf
        <input type="hidden" id="product-id" value="{{ isset($products) ? $products->id : '' }}">
        <div class="form-group">
            <label for="nome">Nome</label>
            <input type="text" class="form-control" name="nome" id="nome"
                value="{{ isset($products) ? $products->nome : '' }}" required placeholder="Nome">
        </div>
        <div class="form-group">
            <label for="valor">Valor</label>
            <input type="text" class="form-control valor" name="valor" id="valor"
                value="{{ isset($products) ? $products->valor : '' }}" required placeholder="Valor">
        ...
        <div class="form-group">
            ...
            <select id="types" name="types[]" multiple="multiple" class="form-control" >
                ...
                @foreach ($types as $type)
                    @if($productsTypes && in_array($type->id, $productsTypes))
        ...
        <div class="form-group">
            ...
            <select id="brandId" name="brandId"  class="form-control" >
                ...
                @foreach ($brands as $brand)
                    @if(isset($products->brand_id) && $brand->id == $products->brand_id)
